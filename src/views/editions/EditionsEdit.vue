  ...
  <div class="editions-edit mw-basic-layout">
    <div class="mw-content">
      <app-title
        :title="
          isUpdatingMode
            ? $t('EDITIONS_EDIT.LABEL.UPDATE')
            : $t('EDITIONS_EDIT.LABEL.CREATE')
        "
      >
        <template slot="back">
      ...
      <form @submit.prevent="save" novalidate>
        <app-info v-if="$v.edition.$invalid">{{
          $t('EDITIONS_EDIT.INFO')
        }}</app-info>
        <md-card>
          <md-card-content>
            <md-field>
              ...
              />
              <span class="md-helper-text" v-if="edition.name === ''">
            ...
            <md-field>
              ...
              />
              <span class="md-helper-text" v-if="edition.url === ''">

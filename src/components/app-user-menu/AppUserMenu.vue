<template>
  <md-menu v-if="user !== null" class="app-user-menu">
    <md-button md-menu-trigger class="md-icon-button" :disabled="isLoading">
      <md-icon v-if="isLoading">account_circle</md-icon>
      <span v-else>
        <img :src="user.photoURL" :alt="user.displayName" class="photo" />
      </span>

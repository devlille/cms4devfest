export default {
  ...
  PARTNER: {
    ...
    CONTACT: {
      NAME: 'Prénom & NOM (contact principal)',
      FUNCTION: 'Rôle (contact principal)',
      PHONE: 'Téléphone (contact principal)',
      EMAILS: 'Emails (personnes actives dans ce partenariat)'
    },
    URL: 'Url',
    LOGO: 'Logo',
  ...
  SPEAKERS_EDIT: {
    ...
    CONFERENCE_HALL: {
      LOADING:
        'Chargement des données depuis ConferenceHall, merci de patienter ...'
    },
    ERRORS: {
      REQUIRED: 'Obligatoire',
      SAVING: 'Echec lors de la sauvegarde.'
  ...
  EDITIONS_IMPORT: {
    ...
    INFO:
      'Les speakers et/ou conférences déjà enregistrés dans le système seront mis à jour avec les données provenant de Conference Hall.',
